...
extension ChatViewController {
    private func bindViewModel() {
        ...
        output.showImagePicker
            .asDriver(onErrorDriveWith: .empty())
            .drive(onNext: { [weak self] imagePickerNavigator in
                ...
                if let imagePickerVC = imagePickerNavigator?.makeViewController() {
        ...
        let dataSource = RxTableViewSectionedReloadDataSource<SectionModel<String, ChatEntity>>(
