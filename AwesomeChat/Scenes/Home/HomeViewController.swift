...
class HomeViewController: UIViewController {
    ...
    private func configContentViewLayer() {
    ...
    private func bindViewModel() {
        ...
        let didTapCell = tableView.rx.itemSelected
            .asObservable()
            .map { $0.row }
        ...
        let dataSource = RxTableViewSectionedReloadDataSource<SectionModel<String, MessageEntity>>(
        ...
        output.bindTableData
            .map {
                [SectionModel(model: "MessageSection", items: $0)]
            }
